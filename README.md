...
<root>
  ...
  ├── Editor
  │   ├── Gauntletrunner2025.Ui.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Gauntletrunner2025.Ui.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Gauntletrunner2025.Ui.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Gauntletrunner2025.Ui.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Gauntletrunner2025.Ui`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package ui Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Gauntletrunner2025.Ui.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Gauntletrunner2025.Ui.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Gauntletrunner2025.Ui.Editor.Tests.asmdef`

  `Tests/Runtime/Gauntletrunner2025.Ui.Tests.asmdef`
...
Use the `Documentations~/ui.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
